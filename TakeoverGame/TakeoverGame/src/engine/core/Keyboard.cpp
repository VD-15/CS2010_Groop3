...
namespace
{
	...
	void ClearInput(PostUpdateEvent& ev)
	{
...
void Keyboard::Init()
{
	...
	EventBus<CharEvent>::Get().AddEventListener(OnChar);
	EventBus<KeyEvent>::Get().AddEventListener(OnKey);
	EventBus<PostUpdateEvent>::Get().AddEventListener(ClearInput);
}
...
void Keyboard::Destroy()
{
	...
	EventBus<CharEvent>::Get().RemoveEventListener(OnChar);
	EventBus<KeyEvent>::Get().RemoveEventListener(OnKey);
	EventBus<PostUpdateEvent>::Get().RemoveEventListener(ClearInput);
}
