...
const extern UInt vlk::VLK_LOG_LEVEL_TRACE = 0;
const extern UInt vlk::VLK_LOG_LEVEL_VERBOSE = 1;
const extern UInt vlk::VLK_LOG_LEVEL_INFO = 2;
const extern UInt vlk::VLK_LOG_LEVEL_WARNING = 3;
const extern UInt vlk::VLK_LOG_LEVEL_ERROR = 4;
const extern UInt vlk::VLK_LOG_LEVEL_FATAL = 5;
const extern UInt vlk::VLK_LOG_LEVEL_ANNOUNCE = 6;
...
std::string vlk::LogLevelToString(UInt level)
{
	switch (level)
	{
		case vlk::VLK_LOG_LEVEL_TRACE:
			return "TRCE";
		case vlk::VLK_LOG_LEVEL_VERBOSE:
			return "VERB";
		case vlk::VLK_LOG_LEVEL_INFO:
			return "INFO";
		case vlk::VLK_LOG_LEVEL_WARNING:
			return "WARN";
		case vlk::VLK_LOG_LEVEL_ERROR:
			return "EROR";
		case vlk::VLK_LOG_LEVEL_FATAL:
			return "FATL";
		case vlk::VLK_LOG_LEVEL_ANNOUNCE:
			return "ANCE";
		default:
			return "NONE";
	}
